...
<template>
  ...
  >
    <div class="h-fit w-full sm:w-96">
      <div class="space-y-4 rounded-t border-x border-t bg-white p-6 shadow">
        <div class="">
          ...
          <div class="my-5 flex flex-wrap">
            <span
              class="mr-3 mb-3 cursor-pointer rounded-full bg-gray-200 px-4 py-2 text-xs font-medium hover:bg-gray-300"
      ...
      <a
        href="#"
        class="flex items-center justify-between rounded-b border bg-white p-6 text-sm shadow hover:bg-gray-100"
      >
        <span
        ...
        <div class="flex items-center">
          ...
          <IconsArrowRight class="h-5 w-5 fill-current text-gray-600" />
        </div>
      </a>
    </div>
    <div class="flex-1">
